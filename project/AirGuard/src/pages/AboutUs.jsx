...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 to-orange-400 text-white py-16">
      <div className="container mx-auto px-6 md:px-12 lg:px-24">
        ...
        <AnimatedSection variants={slideUp} className="text-center mb-16">
          ...
          <div className="relative overflow-hidden w-full h-96">
            <div className="flex w-max animate-loopScroll">
              ...
              {[publicdashboard, user, user, poll2, poll1, publicdashboard, user,poll1, poll2, poll1,].map((img, index) => (
        ...
        <AnimatedSection variants={slideUp} className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {["Laiba Shahzadi", "Ruquiya Nasir", "Umm-e-Aimen"].map((name, index) => (
